...
function M.lsp_keymaps(bufnr)
  ...
  map("n", "gD", function()
    lsp_with_fallback(Snacks.picker.lsp_declarations, vim.lsp.buf.definition)
  ...
  map("n", "<leader>ci", function()
    lsp_with_fallback(Snacks.picker.lsp_incoming_calls, vim.lsp.buf.incoming_calls)
  end, "Incoming calls")
  map("n", "<leader>co", function()
    lsp_with_fallback(Snacks.picker.lsp_outgoing_calls, vim.lsp.buf.outgoing_calls)
  end, "Outgoing calls")
